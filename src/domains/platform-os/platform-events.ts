...
export const __DOMAIN_CATALOG = [
  {
    ...
    events: [
      ...
      { name: 'ModuleDisabled', description: 'Módulo desabilitado para cliente' },
      { name: 'ModuleUpgraded', description: 'Módulo atualizado para nova versão' },
      { name: 'TenantCreated', description: 'Cliente criado na plataforma' },
      { name: 'TenantSuspended', description: 'Cliente suspenso' },
