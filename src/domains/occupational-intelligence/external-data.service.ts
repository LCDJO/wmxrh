 ...
 *   2. IBGE CNAE catalog lookup
 *   3. NR version updates check
 *
 * This replaces direct BrasilAPI calls from the frontend,
 * routing everything through the secured edge function.
 */
