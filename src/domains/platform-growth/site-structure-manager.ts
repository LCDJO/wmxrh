  ...
  createDefault(domain: string): SiteStructure {
    ...
    const structure: SiteStructure = {
      ...
      pages: [
        ...
        this.makePage('solutions', '/solucoes', 'Soluções', 'landing', null, 1),
        this.makePage('pricing', '/planos', 'Planos', 'landing', null, 2),
        this.makePage('features', '/funcionalidades', 'Funcionalidades', 'landing', null, 3),
        this.makePage('about', '/sobre', 'Sobre', 'institutional', null, 4),
        this.makePage('contact', '/contato', 'Contato', 'institutional', null, 5),
        this.makePage('landing-pages', '/landing-pages', 'Landing Pages', 'custom', null, 6),
        this.makePage('terms', '/termos', 'Termos de Uso', 'legal', null, 7, false),
        this.makePage('privacy', '/privacidade', 'Política de Privacidade', 'legal', null, 8, false),
      ],
      createdAt: now,
      updatedAt: now,
    };
