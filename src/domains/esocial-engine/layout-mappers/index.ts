...
import { s1200Mapper } from './s1200-remuneracao.mapper';
...
import { s2299Mapper } from './s2299-desligamento.mapper';
import { s2300Mapper } from './s2300-tsv.mapper';
...
export { s1000Mapper, s1010Mapper, s1200Mapper, s2200Mapper, s2206Mapper, s2220Mapper, s2240Mapper, s2299Mapper, s2300Mapper };
