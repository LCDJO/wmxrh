...
const ALL_MODULES: (ModuleSetupOption & { min_tier: PlanTier })[] = [
  ...
  { module_key: 'intelligence', label: 'Inteligência', description: 'Dashboards de inteligência e analytics.', included_in_plan: true, recommended: true, requires_setup: false, min_tier: 'enterprise' },
