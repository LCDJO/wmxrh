...
const createDefaultTree = (): MenuNode[] => [
  ...
  },
  {
    ...
    children: [
      { id: 'landing-all', label: 'Todas as Páginas', path: '/platform/growth/landing-pages' },
      { id: 'landing-fab', label: 'FAB Builder', path: '/platform/growth/fab-builder' },
      { id: 'landing-submissions', label: 'Meus Rascunhos', path: '/platform/growth/submissions' },
      { id: 'landing-approvals', label: 'Aprovações Pendentes', path: '/platform/growth/approvals' },
      { id: 'landing-published', label: 'Publicadas', path: '/platform/growth/version-publish' },
    ],
  },
  {
    id: 'website', label: 'Website', path: '/platform/website', icon: TrendingUp,
    children: [
      { id: 'web-dashboard', label: 'Dashboard', path: '/platform/website' },
      { id: 'web-pages', label: 'Páginas', path: '/platform/website/pages' },
      { id: 'web-structure', label: 'Estrutura', path: '/platform/website/structure' },
      { id: 'web-seo', label: 'SEO', path: '/platform/website/seo' },
      { id: 'web-ai-designer', label: 'AI Designer', path: '/platform/website/ai-designer' },
      { id: 'web-versions', label: 'Versionamento', path: '/platform/website/versions' },
    ],
  },
