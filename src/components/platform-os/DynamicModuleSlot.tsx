...
import type { WidgetContext, WidgetRenderContext, WidgetRegistryAPI } from '@/domains/platform-os/federation/widget-registry';
import { usePlatformWidgets } from '@/domains/platform-os/ui/usePlatformWidgets';
