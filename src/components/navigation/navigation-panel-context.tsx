...
import type { MenuNode } from '@/domains/navigation-governance/menu-hierarchy-builder';
import type { ResolvedNavigation } from '@/domains/navigation-governance/navigation-refactor-engine';
import { getNavigationRefactorEngine } from '@/domains/navigation-governance/navigation-refactor-engine';
