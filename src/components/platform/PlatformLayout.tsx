...
const NAV_ITEMS: PlatformNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/platform/website/approvals', label: 'Aprovações (Site)', requiredPermission: 'website.approve' },
      { to: '/platform/website/versions', label: 'Versões (Site)', requiredPermission: 'website.publish' },
      { to: '/platform/landing', label: 'Landing Pages', requiredPermission: 'landing_page.view' },
      { to: '/platform/growth/submissions', label: 'Rascunhos LP', requiredPermission: 'landing.view_drafts' },
      { to: '/platform/growth/approvals', label: 'Aprovações LP', requiredPermission: 'landing.approve' },
      { to: '/platform/growth/landing-pages', label: 'Experimentos A/B', requiredPermission: 'landing_page.view' },
      { to: '/platform/growth', label: 'Analytics & Insights' },
      { to: '/platform/growth/insights', label: 'Insights AI' },
      { to: '/platform/growth/conversions', label: 'Conversões' },
      { to: '/platform/marketing/analytics', label: 'Marketing Analytics' },
      { to: '/platform/marketing/rollback', label: 'Smart Rollback' },
      { to: '/platform/campaigns', label: 'Campanhas (em breve)' },
    ],
  },
