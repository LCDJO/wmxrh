...
const NAV_ITEMS: PlatformNavItem[] = [
  ...
  },
  {
    ...
    children: [
      { to: '/platform/growth/submissions', label: 'Rascunhos', requiredPermission: 'landing.view_drafts' },
      { to: '/platform/growth/approvals', label: 'Aprovações', requiredPermission: 'landing.approve' },
      { to: '/platform/growth/landing-pages', label: 'Experimentos A/B', requiredPermission: 'landing_page.view' },
      { to: '/platform/marketing/analytics', label: 'Métricas', requiredPermission: 'growth.view' },
    ],
  },
