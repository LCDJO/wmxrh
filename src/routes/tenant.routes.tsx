...
import TalentHub from '@/pages/hr/TalentHub';
import Employees from '@/pages/employees/Employees';
import EmployeeDetail from '@/pages/employees/EmployeeDetail';
import Companies from '@/pages/hr/Companies';
import CompanyGroups from '@/pages/hr/CompanyGroups';
...
import Audit from '@/pages/hr/Audit';
import PayrollSimulation from '@/pages/hr/PayrollSimulation';
import Notifications from '@/pages/tenant/Notifications';
import WorkforceIntelligence from '@/pages/operations/WorkforceIntelligence';
import StrategicIntelligence from '@/pages/operations/StrategicIntelligence';
...
import TenantCommunicationCenter from '@/pages/tenant/TenantCommunicationCenter';
...
import PccsDashboard from '@/pages/hr/PccsDashboard';
import PccsWizard from '@/pages/hr/PccsWizard';
...
import TenantPlansPage from '@/pages/tenant/TenantPlansPage';
import TenantAppsIntegrations from '@/pages/settings/TenantAppsIntegrations';
import TenantDocumentSignatureIntegration from '@/pages/documents/TenantDocumentSignatureIntegration';
import TelegramIntegration from '@/pages/settings/TelegramIntegration';
import TenantTraccarSettings from '@/modules/traccar/ui/TenantTraccarSettings';
import CpfIntegrationSettings from '@/pages/settings/CpfIntegrationSettings';
import ReferralPage from '@/pages/tenant/ReferralPage';
import TenantEngagement from '@/pages/tenant/TenantEngagement';
...
import ReferenceLetters from '@/pages/employees/ReferenceLetters';
import TimeTrackingPage from '@/pages/operations/TimeTrackingPage';
import TerminationSimulatorPage from '@/pages/employees/TerminationSimulatorPage';
