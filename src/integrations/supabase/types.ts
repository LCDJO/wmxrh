  ...
  public: {
    Tables: {
      ...
      blockchain_hash_registry: {
        ...
        Relationships: [
          {
            foreignKeyName: "blockchain_hash_registry_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_integration_configs: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_integration_configs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      pg_notify_session_event: {
        Args: { event_type: string; session_id: string; user_id: string }
        Returns: undefined
      }
